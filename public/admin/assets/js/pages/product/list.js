             ...
             "render": function ( data, type, full, meta ) {
               if(type === 'display'){
                 ...
                 full['images'].forEach(element => {
                    ...
                    +"<img class=\"rounded-circle\" src=\"/"+element.image.replace('images/', 'thumbnail/250/').replace(/\.(png|jpg|jpeg|JPG)$/i, '.webp') + "\"  onerror=\"javascript:this.src='/" + element.image + "'\"  alt=\"Avatar\">"
                    + "</li>"
                 });
